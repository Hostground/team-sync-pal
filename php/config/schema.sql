...
-- Bestaande installatie: voer deze twee ALTER-regels uit (fout "duplicate column" = al aanwezig, negeren).
ALTER TABLE activities ADD COLUMN lat DOUBLE NULL;
ALTER TABLE activities ADD COLUMN lng DOUBLE NULL;
